...
from benchmark.pathsets.pathsets_benchmarks import PathsetsBenchmarks
...
ALGORITHMS = [
    ("minimalpaths", PathsetsBenchmarks.pyrbdpp_minimalpaths),
]
            ...
            try:
                ...
                for src, dst in tqdm(
                    ...
                    try:
                        ...
                        pathsets, exec_time = algo_func(G, src, dst)
                ...
                if results:
                    ...
                    output_filename = f"{topo_name}_Pathsets_{algo_name}.csv"
